        ...
        <div class="relative modal-box">
            ...
            <p class="flex flex-col space-y-2">
                ...
                <label class="w-full form-control">
                    ...
                    <select class="w-full select select-bordered" wire:model="selected_major">
                        <option></option>
                ...
                <label class="w-full form-control">
                    ...
                    <select class="w-full select select-bordered" wire:model="selected_sub1">
                        <option></option>
                        @foreach ($sub1 as $s1)
                ...
                <label class="w-full form-control">
                    ...
                    <select class="w-full select select-bordered" wire:model="selected_sub2">
                        <option></option>
                        @foreach ($sub2 as $s2)
                ...
                <label class="w-full form-control">
                    ...
                    <select class="w-full select select-bordered" wire:model="selected_sub3">
                        <option></option>
                        @foreach ($sub3 as $s3)
                ...
                <label class="w-full form-control">
                    ...
                    <select class="w-full select select-bordered" wire:model="selected_sub4">
                        <option></option>
                        @foreach ($sub4 as $s4)
