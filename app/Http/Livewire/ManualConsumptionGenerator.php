...
class ManualConsumptionGenerator extends Component
{
    ...
    public function generate_pullout()
    {
        ...
        $returns = DB::select("
            SELECT i.pullout_qty, i.pharm_location_id, s.dmdcomb, s.dmdctr, s.chrgcode, price.acquisition_cost unit_cost, s.retail_price
            ...
            WHERE i.updated_at BETWEEN '" . $from_date . "' AND '" . $to_date . "'
                AND i.pharm_location_id = '" . $location_id . "'
        ");
